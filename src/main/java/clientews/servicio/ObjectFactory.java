...
public class ObjectFactory {
    ...
    private final static QName _ListarPersonas_QNAME = new QName("http://servicio.java.casa.org.ar/", "listarPersonas");
    private final static QName _ListarPersonasResponse_QNAME = new QName("http://servicio.java.casa.org.ar/", "listarPersonasResponse");
    private final static QName _Persona_QNAME = new QName("http://servicio.java.casa.org.ar/", "persona");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.java.casa.org.ar/", name = "listarPersonas")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.java.casa.org.ar/", name = "listarPersonasResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.java.casa.org.ar/", name = "persona")
